    ...
    <div class="d-flex">
        <div class="me-5 d-flex">
            <div class="d-flex align-items-center">
                ...
                <a href="<?php echo e(route("localization", ["lang"=>"id"])); ?>" class="fw-bold text-decoration-none text-secondary">ID</a>
            </div>
            ...
            <div class="d-flex align-items-center">
                ...
                <a href="<?php echo e(route("localization", ["lang"=>"en"])); ?>" class="fw-bold text-decoration-none text-secondary">EN</a>
            </div>
        </div>
        <div class="me-2">
...
</nav><?php /**PATH C:\BINUS5\UJIAN_AKHIR_SEMESTER_5\WebProgggg\JAWABAN\web_amazing_e_grocery\resources\views/Navbar/user_navbar.blade.php ENDPATH**/ ?>